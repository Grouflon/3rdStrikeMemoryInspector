...
int DInputKeyCodeToVirtualKeyCode(int _DInputKeyCode)
{
	switch (_DInputKeyCode)
	{
		case DIK_ESCAPE          : return VK_ESCAPE;
		case DIK_1               : return VK_KEY_1;
		case DIK_2               : return VK_KEY_2;
		case DIK_3               : return VK_KEY_3;
		case DIK_4               : return VK_KEY_4;
		case DIK_5               : return VK_KEY_5;
		case DIK_6               : return VK_KEY_6;
		case DIK_7               : return VK_KEY_7;
		case DIK_8               : return VK_KEY_8;
		case DIK_9               : return VK_KEY_9;
		case DIK_0               : return VK_KEY_0;
		...
		case DIK_Q               : return VK_KEY_Q;
		case DIK_W               : return VK_KEY_W;
		case DIK_E               : return VK_KEY_E;
		case DIK_R               : return VK_KEY_R;
		case DIK_T               : return VK_KEY_T;
		case DIK_Y               : return VK_KEY_Y;
		case DIK_U               : return VK_KEY_U;
		case DIK_I               : return VK_KEY_I;
		case DIK_O               : return VK_KEY_O;
		case DIK_P               : return VK_KEY_P;
		...
		case DIK_A               : return VK_KEY_A;
		case DIK_S               : return VK_KEY_S;
		case DIK_D               : return VK_KEY_D;
		case DIK_F               : return VK_KEY_F;
		case DIK_G               : return VK_KEY_G;
		case DIK_H               : return VK_KEY_H;
		case DIK_J               : return VK_KEY_J;
		case DIK_K               : return VK_KEY_K;
		case DIK_L               : return VK_KEY_L;
		...
		case DIK_Z               : return VK_KEY_Z;
		case DIK_X               : return VK_KEY_X;
		case DIK_C               : return VK_KEY_C;
		case DIK_V               : return VK_KEY_V;
		case DIK_B               : return VK_KEY_B;
		case DIK_N               : return VK_KEY_N;
		case DIK_M               : return VK_KEY_M;
		...
		case DIK_OEM_102         : return VK_OEM_102;
		...
		case DIK_KANA            : return VK_KANA;
		case DIK_ABNT_C1         : return VK_ABNT_C1;
		case DIK_CONVERT         : return VK_CONVERT;
		case DIK_NOCONVERT       : return VK_NONCONVERT;
		case DIK_YEN             : return 0x0000;
		case DIK_ABNT_C2         : return VK_ABNT_C2;
		case DIK_NUMPADEQUALS    : return 0x0000;
		case DIK_PREVTRACK       : return 0x0000;
		case DIK_AT              : return 0x0000;
		case DIK_COLON           : return 0x0000;
		case DIK_UNDERLINE       : return 0x0000;
		case DIK_KANJI           : return VK_KANJI;
		case DIK_STOP            : return 0x0000;
		case DIK_AX              : return 0x0000;
		case DIK_UNLABELED       : return 0x0000;
		case DIK_NEXTTRACK       : return 0x0000;
		case DIK_NUMPADENTER     : return VK_RETURN;
		case DIK_RCONTROL        : return VK_RCONTROL;
		case DIK_MUTE            : return 0x0000;
		case DIK_CALCULATOR      : return 0x0000;
		case DIK_PLAYPAUSE       : return 0x0000;
		case DIK_MEDIASTOP       : return 0x0000;
		case DIK_VOLUMEDOWN      : return 0x0000;
		case DIK_VOLUMEUP        : return 0x0000;
		case DIK_WEBHOME         : return 0x0000;
		case DIK_NUMPADCOMMA     : return VK_DECIMAL;
		case DIK_DIVIDE          : return VK_DIVIDE;
		case DIK_SYSRQ           : return 0x0000;
		...
		case DIK_APPS            : return 0x0000;
		case DIK_POWER           : return 0x0000;
		case DIK_SLEEP           : return 0x0000;
		case DIK_WAKE            : return 0x0000;
		case DIK_WEBSEARCH       : return 0x0000;
		case DIK_WEBFAVORITES    : return 0x0000;
		case DIK_WEBREFRESH      : return 0x0000;
		case DIK_WEBSTOP         : return 0x0000;
		case DIK_WEBFORWARD      : return 0x0000;
		case DIK_WEBBACK         : return 0x0000;
		case DIK_MYCOMPUTER      : return 0x0000;
		case DIK_MAIL            : return 0x0000;
		case DIK_MEDIASELECT     : return 0x0000;
